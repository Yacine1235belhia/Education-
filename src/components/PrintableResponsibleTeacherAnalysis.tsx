            ...
            >
              {isFirstPage && (
                <>
                  <div style={{ backgroundColor: '#f3f4f6', padding: '12px', textAlign: 'center', marginBottom: '10px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                    <h1 style={{ fontSize: '20px', fontWeight: '900', margin: '0', color: '#111827' }}>التحليل الإحصائي لنتائج القسم</h1>
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', marginTop: '8px', fontSize: '14px', fontWeight: '700', color: '#4b5563' }}>
                      <span>خاصية الأستاذ المسؤول</span>
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
                     <div style={{ flex: 1, padding: '12px', backgroundColor: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '8px', textAlign: 'center' }}>
                       <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#1e40af' }}>المعدل العام</div>
                     ...
                     <div style={{ flex: 1, padding: '12px', backgroundColor: '#ecfdf5', border: '1px solid #a7f3d0', borderRadius: '8px', textAlign: 'center' }}>
                       <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#047857' }}>نسبة النجاح</div>
                     ...
                     <div style={{ flex: 1, padding: '12px', backgroundColor: '#fffbeb', border: '1px solid #fde68a', borderRadius: '8px', textAlign: 'center' }}>
                       <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#b45309' }}>أعلى معدل</div>
                     ...
                     <div style={{ flex: 1, padding: '12px', backgroundColor: '#fff1f2', border: '1px solid #fecdd3', borderRadius: '8px', textAlign: 'center' }}>
                       <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#be123c' }}>أدنى معدل</div>
                  ...
                  <div style={{ marginBottom: '20px', border: '1px solid #e5e7eb', padding: '10px', borderRadius: '8px' }}>
                    <h3 style={{ fontSize: '14px', fontWeight: '900', marginBottom: '8px', borderBottom: '1px solid #e5e7eb', paddingBottom: '4px' }}>توزيع المعدلات</h3>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', fontSize: '12px', fontWeight: 'bold' }}>
                       <span style={{ backgroundColor: '#e0e7ff', color: '#3730a3', padding: '4px 8px', borderRadius: '4px' }}>ممتاز: {brackets.excellent}</span>
                       <span style={{ backgroundColor: '#cffafe', color: '#164e63', padding: '4px 8px', borderRadius: '4px' }}>جيد جدا: {brackets.veryGood}</span>
                       <span style={{ backgroundColor: '#d1fae5', color: '#065f46', padding: '4px 8px', borderRadius: '4px' }}>جيد: {brackets.good}</span>
                       <span style={{ backgroundColor: '#ecfccb', color: '#3f6212', padding: '4px 8px', borderRadius: '4px' }}>متوسط: {brackets.satisfactory}</span>
                       <span style={{ backgroundColor: '#fef3c7', color: '#92400e', padding: '4px 8px', borderRadius: '4px' }}>مقبول: {brackets.acceptable}</span>
                       <span style={{ backgroundColor: '#ffedd5', color: '#9a3412', padding: '4px 8px', borderRadius: '4px' }}>دون المتوسط: {brackets.insufficient}</span>
                       <span style={{ backgroundColor: '#ffe4e6', color: '#9f1239', padding: '4px 8px', borderRadius: '4px' }}>ضعيف: {brackets.weak}</span>
                    </div>
                  </div>
                </>
              )}
              ...
              <table style={{ width: '100%', textAlign: 'center', borderCollapse: 'collapse', border: '2px solid #000000', fontSize: '12px', tableLayout: 'fixed' }}>
                ...
                <thead style={{ display: 'table-header-group' }}>
                  <tr style={{ backgroundColor: '#e5e7eb' }}>
                    <th style={{ padding: '4px 2px', fontWeight: '900', border: '1px solid #000000', fontSize: '12px' }}>الاسم واللقب</th>
                    ...
                    <th style={{ padding: '4px 2px', fontWeight: '900', border: '1px solid #000000', fontSize: '12px', backgroundColor: '#d1d5db' }}>المعدل العام</th>
                  </tr>
                </thead>
                <tbody>
                  {chunk.map((student, innerIndex) => (
                    <tr key={innerIndex} style={{ borderBottom: '1px solid #000000' }}>
                      <td style={{ padding: '4px', fontWeight: '700', border: '1px solid #000000', textAlign: 'right', fontSize: '11px' }}>{student.name}</td>
                      {subjectHeaders.map(h => (
                ...
                {(index === studentChunks.length - 1) && (
                  <tfoot>
                    <tr style={{ backgroundColor: '#ecfdf5', fontWeight: 'bold' }}>
                      <td style={{ padding: '6px', border: '1px solid #000000', color: '#064e3b' }}>معدل المادة</td>
                      {subjectHeaders.map(h => (
                    ...
                    <tr style={{ backgroundColor: '#eff6ff', fontWeight: 'bold' }}>
                      <td style={{ padding: '6px', border: '1px solid #000000', color: '#1e3a8a' }}>نسبة النجاح %</td>
                      {subjectHeaders.map(h => (
              ...
              {index === studentChunks.length - 1 && aiAnalysis && (
                <div style={{ marginTop: '30px', padding: '15px', border: '1px solid #e5e7eb', borderRadius: '8px', backgroundColor: '#f9fafb' }}>
                  <h3 style={{ fontSize: '14px', fontWeight: '900', marginBottom: '10px', color: '#111827', borderBottom: '1px solid #e5e7eb', paddingBottom: '5px' }}>التحليل والتوجيهات البيداغوجية</h3>
